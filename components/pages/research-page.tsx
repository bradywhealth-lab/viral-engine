  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">Discover untapped niches and find sports card auction opportunities.</p>
      </div>
                    ...
                    <CardDescription>
                      <div className="mt-2">
                        <div className="mb-1 flex justify-between text-xs">
                          <span className="text-zinc-400">Growth Score</span>
                    ...
                    <tbody className="text-sm">
                      {auctionResults.map((result) => (
                        <tr key={result.id} className="border-b border-zinc-800/50">
                          ...
                          <td className="py-3 pr-4 text-zinc-300">{result.set}</td>
                          <td className="py-3 pr-4 text-zinc-300">{result.year}</td>
                          <td className="py-3 pr-4 text-zinc-300">{result.grade}</td>
                          <td className="py-3 pr-4 font-medium text-emerald-400">${result.soldPrice.toLocaleString()}</td>
                          <td className="py-3 pr-4 text-zinc-300">{result.soldAt}</td>
                          <td className="py-3">
                            <a
