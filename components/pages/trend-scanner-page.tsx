  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">Search by keyword, niche, and platform to capture current momentum and convert it into ideas.</p>
      </div>
            ...
            <CardContent>
              <div className="rounded-3xl border border-zinc-800 bg-zinc-950/80 p-6">
                ...
                <div className="mt-4 h-4 overflow-hidden rounded-full bg-zinc-800">
                  <div className="h-full rounded-full bg-gradient-to-r from-amber-400 via-orange-500 to-red-500" style={{ width: `${result.trendScore}%` }} />
                </div>
            ...
            <CardContent className="grid gap-4">
              {result.ideas.map((idea) => (
                <div key={idea.title} className="rounded-2xl border border-zinc-800 bg-zinc-950/70 p-4">
                  ...
                  <p className="mt-3 text-sm text-zinc-300">{idea.caption}</p>
